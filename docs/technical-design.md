...
**Дополнение C6 по ответам D1–D2:** [оформление дома](home-decoration-contract.md).
Отдельные обои, цель и свободное переключение по серверному уровню; XP не
тратятся и не начисляются за оформление. Это новые изолированные endpoints,
не изменение meal API 1.3. Общий статус проверки —
[вторая волна](reviews/2026-09-06-poc-wave-2.md).
